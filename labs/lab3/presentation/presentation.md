...
![(1-4 пункты задания лабораторной)](image/1.PNG){ #fig:001 width=70% height=70% }
...
![(5-7 пункты задания лабораторной)](image/2.PNG){ #fig:002 width=70% height=70% }
...
![( 8 пункт задания лабораторной)](image/3.PNG){ #fig:003 width=70% height=70% }
...
![(10-11 пункты задания лабораторной)](image/5.PNG){ #fig:005 width=70% height=70% }

# Заполнение таблиц

## «Установленные права и разрешённые действия для групп пользователей» (см. табл. 3.1)
