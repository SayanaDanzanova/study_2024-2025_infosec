---
## Front matter
title: "Отчёт по лабораторной работе №3. Информационная безопасность"
...
![(рис. 1. Пункты 1-4 лабораторной работы)](image/1.PNG){ #fig:001 width=70% height=70% }
...
![(рис. 2. Пункты 5-7 лабораторной работы)](image/2.PNG){ #fig:002 width=70% height=70% }

7. Сравните полученную информацию с содержимым файла /etc/group :

![(рис. 3. Пункт 8 лабораторной работы)](image/3.PNG){ #fig:003 width=70% height=70% }

8. От имени пользователя guest2 выполните регистрацию пользователя guest2 в группе guest командой newgrp guest :

![(рис. 4. Пункт 9 лабораторной работы)](image/4.PNG){ #fig:004 width=70% height=70% }
...
![(рис. 5. Пункты 10-11 лабораторной работы)](image/5.PNG){ #fig:005 width=70% height=70% }
