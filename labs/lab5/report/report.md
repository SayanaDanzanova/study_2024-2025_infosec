...
author: "Выполнила: Данзанова Саяна Зоригтоевна, НПИбд-01-21, 1032217624"
...
![(рис. 12. 1-3 пункты)](image/10.PNG){ #fig:012 width=70% height=70% }
...
![(рис. 13. 4-12 пункты)](image/11.PNG){ #fig:013 width=70% height=70% }
...
![(рис. 15. Возвращение атрибута)](image/12.PNG){ #fig:015 width=70% height=70% }
